...
#regularization >>بنختار بعض عناصر الثيتاتا او جزء منها واعمل معاملاتها اكسات والالجورزم هيختار الثيتات المناسبة للمعاملات عشان نجيب المينيمم ونتجنب الاوفرفيت

path = 'C:\\Users\\20100\\Desktop\\data science\\machine learning\\projects\\classification\\classification with reularization\\classification with regularization.txt'
...
####making regularization for test1,test2
degree = 5
x1 = data['Test 1']
x2 = data['Test 2']
