...
data2[(data2['star_rating'] > 1)&(data2['latest_price'] < 100000)].plot(kind='hexbin',x='star_rating',y='latest_price',alpha=0.5,cmap=plt.cm.Greens,sharex=False,gridsize=25)
plt.show()
